      ...
      body: Center(
        child: Column(
          children: [
            ...
            newButton(text: "Entrada de estoque", function: () => Navigator.pushNamed(context, Routes.stockEntry),),
            newButton(text: "Saida de estoque", function: () => Navigator.pushNamed(context, Routes.stockOut),),
